...
public class ServerThread implements Runnable{
	...
	public void run() {
		...
		byte[] bt = null;
		new BASE64Decoder().decodeBuffer(ticketPServerEncipher);
...
//		String keyCAndPServer=jsonticketPServer.getString("keyCAndPServer");
		...
		byte[] bt1 = null;
		new BASE64Decoder().decodeBuffer(AuthenticatorCEncipher);
	...
	private class BASE64Decoder {
		public void decodeBuffer(String authenticatorCEncipher) {
		}}
	}
